...
public class ${className}Controller {
    ...
    *  @Date ${.now}
    */
    @PostMapping("/${path1}/${path2}/detail")
    ...
    *  @Date ${.now}
    */
    @PostMapping("/${path1}/${path2}/delete")
